    ...
    definition: {
        ...
        components: {
            ...
            schemas: {
                ...
                // Step-related schemas
                StepStatus: {
                    type: "string",
                    enum: ["pending", "in_progress", "completed", "skipped"],
                    description: "Status of a job step. 'skipped' is only valid for skippable steps (isSkippable: true)"
                },
                JobStep: {
                    type: "object",
                    properties: {
                        id: { type: "integer", example: 1 },
                        jobStageId: { type: "integer", example: 1 },
                        stepTemplateId: { type: "integer", example: 1 },
                        ...
                        stepTemplate: {
                            ...
                            properties: {
                                id: { type: "integer" },
                                name: { type: "string", example: "ถอดชิ้นส่วน" },
                                orderIndex: { type: "integer" },
                                isSkippable: { type: "boolean", example: true }
                            }
                        },
                        employee: {
                            type: "object",
